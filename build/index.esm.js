...
import { MainTitle, Paragraph, Image, Divider, Heading, Strong } from 'react-email-components-typography';
import { Table } from 'react-email-components-table';
import 'react-emails-components-miscellaneous';
...
var BodyPrototype = function BodyPrototype() {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(build.exports.Sponsor, {
    leftHref: "https://bit.ly/30AWyC4",
    rightHref: "https://bit.ly/30AWyC4",
    leftSrc: "https://raw.githubusercontent.com/atherdon/newsletters/master/archive/logos/thematic/2020/September/flatfile-logo-black-small-vertical.png"
  }, "Ship the data importer you always dreamed of"), /*#__PURE__*/React.createElement(MainTitle, null, "Can We Make Data Tidy?"), /*#__PURE__*/React.createElement(Paragraph, null, "Imagine: You are going to sit down with a newly-fetched data set, excited about the insights it will bring you and then you find out it is no use. If you\u2019ve been there, then you know for sure what an untidy dataset is."), /*#__PURE__*/React.createElement(Image, {
    href: "#",
    src: "https://raw.githubusercontent.com/atherdon/newsletters/master/archive/img/memes/6.jpg",
    alt: "GIF"
  }), ' ', "I", /*#__PURE__*/React.createElement(Divider, null), /*#__PURE__*/React.createElement(Paragraph, null, "A statistician from New Zealand once said: Tidy datasets are all alike, but every messy dataset is messy in its own way. Indeed, as data may come in various forms and shapes, sometimes we are inundated with it. As a result, our data science team becomes shortsighted and oops.. disillusioned by mountains of unworkable data. The only way data specialists can facilitate analysis is by keeping data clean and organized."), /*#__PURE__*/React.createElement(Heading, null, /*#__PURE__*/React.createElement(Strong, null, "What is tidy data?")), /*#__PURE__*/React.createElement(Paragraph, null, "Essentially, tidy data is a term coined by Hadley Wickham in his Tidy Data paper (remember that statistician from NZ?). He defined tidy data as data that is neatly organized and all set for analysis. This way of organizing allows you to easily produce charts, diagrams, and summary statistics. As it often happens, not all data comes out of the database clean, therefore cleansing it is essential to efficiently analyze it."), /*#__PURE__*/React.createElement(Image, {
    href: "#",
    src: "https://raw.githubusercontent.com/atherdon/newsletters/master/archive/img/memes/1.png"
  }), /*#__PURE__*/React.createElement(Divider, null), /*#__PURE__*/React.createElement(Paragraph, null, "Without further ado, let us break down the principles that allow you keep your data nice and clean."), /*#__PURE__*/React.createElement(Heading, null, /*#__PURE__*/React.createElement(Strong, null, "Tidy Data Principles")), /*#__PURE__*/React.createElement(Heading, null, /*#__PURE__*/React.createElement(Strong, null, "1. Each row is an observational unit.")), /*#__PURE__*/React.createElement(Image, {
    href: "#",
    src: "https://raw.githubusercontent.com/atherdon/newsletters/master/archive/img/image1.png"
  }), /*#__PURE__*/React.createElement(Divider, null), /*#__PURE__*/React.createElement(Paragraph, null, "We\u2019ll start with one of the basic principles. When you are giving your data the once-over, you should make sure each row contains an observation. By definition, observation is the individual unit under question. If we look at the table above, an observational unit could be called \u2018people\u2019. You can see that each person has an individual row on the table and all of the information for that person is in the same row. Observations are included in rows, variables are represented as columns and there is only one observational unit per table. Now THIS is tidy data."), /*#__PURE__*/React.createElement(Divider, null), /*#__PURE__*/React.createElement(build.exports.Sponsor, {
    leftHref: "https://bit.ly/30AWyC4",
    rightHref: "https://bit.ly/30AWyC4",
    leftSrc: "https://raw.githubusercontent.com/atherdon/newsletters/master/archive/logos/thematic/2020/September/flatfile-logo-black-small-vertical.png"
  }, "Ship the data importer you always dreamed of"));
